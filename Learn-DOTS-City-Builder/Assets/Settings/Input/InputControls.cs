...
public partial class @InputControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                {
                    ""name"": ""MouseMovementMode"",
                    ""type"": ""Button"",
                    ""id"": ""6d59f9d5-dfdd-437b-8aff-bfd5cd575c42"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""73924f4a-0bec-477c-8225-1c52311b6a4d"",
                    ""path"": ""<Mouse>/rightButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""MouseMovementMode"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": []
        ...
        m_CameraMap_MouseMovementMode = m_CameraMap.FindAction("MouseMovementMode", throwIfNotFound: true);
        // BuildingMode
    ...
    ~@InputControls()
    {
        UnityEngine.Debug.Assert(!m_CameraMap.enabled, "This will cause a leak and performance issues, InputControls.CameraMap.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_BuildingMode.enabled, "This will cause a leak and performance issues, InputControls.BuildingMode.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_CameraMap_MouseMovementMode;
    public struct CameraMapActions
    {
        ...
        public InputAction @MouseMovementMode => m_Wrapper.m_CameraMap_MouseMovementMode;
        ...
        public void AddCallbacks(ICameraMapActions instance)
        {
            ...
            @MouseMovementMode.started += instance.OnMouseMovementMode;
            @MouseMovementMode.performed += instance.OnMouseMovementMode;
            @MouseMovementMode.canceled += instance.OnMouseMovementMode;
        }
    ...
    public interface ICameraMapActions
    {
        ...
        void OnMouseMovementMode(InputAction.CallbackContext context);
    }
